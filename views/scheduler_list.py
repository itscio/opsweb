...
from Modules import produce,check,db_op,loging,main_info
import time
...
def scheduler_list():
    ...
    return render_template('scheduler_list.html',Main_Infos=g.main_infos,tables=tables,values=values)
