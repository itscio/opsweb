该平台整合业界开源自动化运维工具结合自主研发，致力于打造CI/CD全链路平台和一站式综合管理平台。由于使用cas方式登录验证、平台配置文件及依赖底层数据源众多建议只做代码交流学习.因项目开发进度问题代码注释比较少,只注释重要逻辑部分,见谅！别忘了给个star^_^
...
# 主要功能： #
    ...
    - 生产环境基于git、jinkens、harbor、k8s容器化实现的CI\CD流水线 
